...
void sie_status_other_event_handler() {
    ...
    if (sie_status & USB_SIE_STATUS_ACK_REC_BITS) {
        ...
        printf("Serial Interface Engine, ACK Received, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_STALL_REC_BITS) {
        ...
        printf("Serial Interface Engine, Stall Received, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_NAK_REC_BITS) {
        ...
        printf("Serial Interface Engine, NAK Received, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_TRANS_COMPLETE_BITS) {
        ...
        printf("Serial Interface Engine, Transaction Complete, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_CONNECTED_BITS) {
        ...
        printf("Serial Interface Engine, Device Connected, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_RESUME_BITS) {
        ...
        printf("Serial Interface Engine, Host Resume, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_VBUS_OVER_CURR_BITS) {
        ...
        printf("Serial Interface Engine, VBUS Over Current, Register=%08x \n\r", sie_status);
    ...
    if (sie_status & USB_SIE_STATUS_VBUS_DETECTED_BITS) {
        ...
        printf("Serial Interface Engine, VBUS Detected, Register=%08x \n\r", sie_status);
