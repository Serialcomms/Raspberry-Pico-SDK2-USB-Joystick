...
void sie_status_data_sequence_error() {
  ...
  printf("USB Serial Interface Engine, Data Sequence Error\n\r" );
...
void sie_status_receive_error_handler() {
  ...
  if (sie_errors & USB_SIE_STATUS_RX_TIMEOUT_BITS) {
    ...
    printf("Serial Interface Engine, Receive Timeout Error, Register=%08x \n\r", sie_errors);
  ...
  if (sie_errors & USB_SIE_STATUS_RX_OVERFLOW_BITS) {
    ...
    printf("Serial Interface Engine, Receive Overflow Error, Register=%08x \n\r", sie_errors);
  ...
  if (sie_errors & USB_SIE_STATUS_BIT_STUFF_ERROR_BITS) {
    ...
    printf("Serial Interface Engine, Bit Stuffing Error, Register=%08x \n\r", sie_errors);
  ...
  if (sie_errors & USB_SIE_STATUS_CRC_ERROR_BITS) {
    ...
    printf("Serial Interface Engine, CRC Error, Register=%08x \n\r", sie_errors);
